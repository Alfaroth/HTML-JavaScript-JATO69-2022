// indirizzo che contiene gli utenti 
...
if (localUser.citta == "Torino") {
    map = L.map('map').setView([45.0671768,7.6851458], 13);
} else if (localUser.citta == "Roma") {
    map = L.map('map').setView([41.8926905,12.4844279], 13);
} else if (localUser.citta == "Napoli") {
     map = L.map('map').setView([40.8346127,14.2504535], 13);
}
